...
Users on the [Workers Free plan](https://developers.cloudflare.com/workers/platform/plans/#free) are limited to **10 minutes of browser rendering usage per day**.

To increase this limit, you’ll need to [upgrade to a Workers Paid plan](https://developers.cloudflare.com/workers/platform/plans/#paid).
