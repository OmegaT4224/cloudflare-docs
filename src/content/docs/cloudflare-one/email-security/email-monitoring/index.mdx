...
Email Retro Scan allows you to scan up to 14 days of old messages in your Microsoft 365 inboxes and check if your current email security solution missed any threats. To start a free scan:

1. Log in to [Zero Trust](https://one.dash.cloudflare.com/).
2. Select **Email Security**.
3. Under **Email Security**, select **Monitoring**.
4. Select **Start a free scan** > **Generate report**.
5. Enable [Microsoft integration](/cloudflare-one/email-security/setup/post-delivery-deployment/api/office365-api/#enable-microsoft-integration).
6. Generate Retro Scan report:
   ...
   - **Review details**: Review the details you previously selected. Then, select **Continue**.
7. You will be notified by email once the report is available. Once you have received your email, select **View report**.
